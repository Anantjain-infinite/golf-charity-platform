        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#13131A;border-radius:16px;border:1px solid #2A2A3D;max-width:600px;width:100%;">
          ...
          <tr>
            <td style="padding:40px;">
              <div style="display:inline-block;background-color:#10B98120;color:#10B981;padding:8px 16px;border-radius:8px;font-size:13px;font-weight:600;margin-bottom:24px;">Claim Approved</div>
              <h2 style="margin:0 0 16px;color:#F9FAFB;font-size:28px;font-weight:700;">Great news, ${fullName}</h2>
              <p style="margin:0 0 24px;color:#9CA3AF;font-size:16px;line-height:1.6;">
                Your prize claim for the ${drawMonth} draw has been approved. Your payment of GBP ${prizeAmount} is being processed and will be sent to you shortly.
              </p>
